...
<form name="returnlist" action="TransactionController"  onsubmit=" return validateRefIdBTM()" >
...
<tr>
<td>
<input type="text" name="refid" id="refid"  onBlur="return validateRefIdBTM()">
</td><td><span id="refIDSpan"></span></td>
<td>
<input type="hidden" value="returnf" name="action">
<input type="submit" value="return" onclick= "alert('returned')">
