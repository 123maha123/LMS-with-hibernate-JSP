...
<body bgcolor="#e1f2f8">  
    ...
    <br>
    <br>
    <font face="Times New Roman" size=5 color="black"><b><u>Delete Magazine : </u></b></font><br><br>
    </center>
    <form name="deleteMagazineByIdForm" method="post" action="DeleteMagazineById">
    	<table align="center">
    		<tr>
    		...
    		<tr>
    			<th><input type="hidden" value="deleteMagazineById" name="action" /></th>
    			<td><input type="submit" id="submit" name="submit" value="Delete Magazine" onClick="return validateRefID()"></td>
    			<td></td>
    		</tr>
    	</table>
    </form>
