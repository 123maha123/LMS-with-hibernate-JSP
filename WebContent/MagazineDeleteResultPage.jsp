...
<%
boolean deleteFlag=(Boolean)request.getAttribute("deleteFlag");
if(deleteFlag)
{%>
	Magazine is successfully deleted!
<%}
else
{%>
	Sorry, the Magazine is not deleted successfully. Please try again!
<%}
%>
</font>
</center>
