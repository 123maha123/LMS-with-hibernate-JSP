...
<p align="center">Renew Books</p>

<form name ="renew" action="TransactionController" onsubmit="return validateReneww()" >
<table align="center">
<tr>
      <td>MemberID</td><td><input type="text" id="memberId" name="mid" onBlur="return validatememberId()"></td>
     <td><span id="midSpan"></span></td>
  </tr>
<tr><td><input type="submit" value ="search"></td></tr>
</table>
<input type="hidden" value="renewal" name="action">
</form>
