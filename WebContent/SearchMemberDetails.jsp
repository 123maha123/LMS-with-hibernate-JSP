...
<center>
<br><br><br><br>
<form name="search"  action="FineController"  method="post">
 <table>
<tr>
<td>Member Id</td>
<td><input type="text" name="memberid" id="memberid" value="" onBlur=" return Validate();">
...
<tr>
<td>Fromdate</td>
<td><input type="text" name="fromdate" id="fromdate" value="" onBlur="return fromValidate(); "></td>
<td><span id="fromSpan"></span></td>
</tr>
<tr>
<td>Todate</td>
<td><input type="text" name="todate" id="todate" value="" onBlur="return toValidate();"></td>
<td><span id="toSpan"></span></td>
</tr>
</table>
<br>
<input type="submit"  name="search" value="SEARCH" onclick="return validateSearch();">
<input type="reset" value="RESET" onclick="clearForm();">
<input type="hidden" name="action"  id="dl" value="memberdetails">
</form>
</center>
</div>
</body>
