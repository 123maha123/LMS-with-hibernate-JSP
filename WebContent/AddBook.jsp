...
<body bgcolor="#e1f2f8">  
    ...
    <center>
    <br><br>
    <font face="Times New Roman" size=5 color="black"><b><u>Add Book : </u></b></font><br><br>
    </center>
    <form name="addBookForm" method="post" action="AddBook">
    	<table align="center">
    		<tr>
    			<th><label>ISBN : </label></th>
    			<td><input type="text" id="isbn" name="isbn" onBlur="return validateIsbn()"></td>
    		...
    		<tr>
    			...
    			<td><input type="text" id="edition" name="edition" onBlur="return validateEdition()"></td>
    			<td><span id="editionSpan"></span></td>
    		</tr>
    		<tr>
    			<th><label>Author : </label></th>
    			<td><input type="text" id="author" name="author" onBlur="return validateAuthor()"></td>
    			<td><span id="authorSpan"></span></td>
    		</tr>
    		<tr>
    			<th><label>Editor : </label></th>
    			<td><input type="text" id="editor" name="editor" onBlur="return validateEditor()"></td>
    		...
    		<tr>
    			<th><input type="hidden" value="addBook" name="action" /></th>
    			<td><input type="submit" id="submit" name="submit" value="Add Book" onClick="return validateBook()"></td>
    			<td><input type="reset" value="reset" id="reset" name="reset" onClick="resetBookSpan()"></td>
    		</tr>
    	</table>
    </form>
	</div>
