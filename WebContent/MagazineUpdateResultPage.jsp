...
<%
String referenceID=request.getAttribute("referenceID").toString();
if(referenceID.equals("no"))
{%>
	Sorry, the magazine is not updated successfully. Please try again!
<%}
else
{%>
	Magazine with Reference Id : <%=referenceID %> is successfully updated!
<%}
%>
</font>
</center>
