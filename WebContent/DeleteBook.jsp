...
<body bgcolor="#e1f2f8">  
    ...
    <br>
    <br>
    <font face="Times New Roman" size=5 color="black"><b><u>Delete Book : </u></b></font><br><br>
    </center>
    <form name="deleteBookByIdForm" method="post" action="DeleteBookById">
    	<table align="center">
    		<tr>
    		...
    		<tr>
    			<th><input type="hidden" value="deleteBookById" name="action" /></th>
    			<td><input type="submit" id="submit" name="submit" value="Delete Book" onClick="return validateRefID()"></td>
    			<td></td>
    		</tr>
    	</table>
    </form>
