...
<p align="center">Issue Book</p>
 
<form name ="Login" action="TransactionController" onsubmit="return validateIssueBook()">
...
<tr><td>ISBN</td><td><input type="text" id="isbn" name="isbn" onBlur="return validateIsbn()"></td><td><span id="isbnSpan"></span></td></tr>
...
<tr><td><input type="submit" value="issuebook" onclick=' return validateBook()'></td></tr>
</table>
</form>
